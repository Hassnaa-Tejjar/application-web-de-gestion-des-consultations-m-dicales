...
try {
  ...
  $connexionDB = new PDO("mysql:host=localhost;dbname=db_healthcare", "root", ""); 
   $requete ="SELECT *from  patient where Id_patient = '".$_GET["edit"]."'";
...
<div class="modal-dialog" role="document">
  <div class="modal-content" >
    <div style="border:4px solid #0ABAB5;width:600px;margin-left:300px;">
     <div class="modal-header"style="background-color:#0ABAB5;border: 1px solid white; width: 600px; height: 120px;margin-right: 500px;margin-right:60px ;margin-left: 0px">
       <h2 class="modal-title" style="text-align: center; font-size: 40px"> <img src="image\hospitalisation.png" width="80"><strong >FICHE PATIENT</strong></h2>
     </div>
     <div class="modal-body">
       <br/>
       <form method="post" id="insert_form" action="modifierPat.php">
          ...
          <div style="border-left:3px  solid #1E7FCB;margin-left: 75px">
           ...
           <h4><b><u style="color:#791CF8;text-decoration:none;font-size:26px ;margin-left: 50px" > <img src="image\img1.png" width="50"style="margin:5px" >Antécédents </u></b></h4>
               ...
               <div class="modal-footer">
                <table><th>
                 <div style=" border: 1px solid white; background-color:#DB1702;  width: 110px; height: 48px;margin-left: 200px" ><a href="listePatient.php" type="reset" style="color:black"  ><strong>Annuler</strong> <img src="image\cancel.png" width="30"  style="margin:5px" ></a></div></th>
                 <th>
                 <button type="submit" name="insert" id="insert" value="Modifier" class="btn btn-primary"style="color:black;background-color:#689D71"  ><strong>Modifier</strong> <img src="image\checkk.png" width="30"style="margin:5px" ></button>
               </th>
               </table>
               </div>
        </form>
