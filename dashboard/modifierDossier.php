...
<div id="add_data_Modal" class="modal fade" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
        	<div style=" border: 4px solid #76D7C4 ;width: 700px;margin-left: 300px;">
            ...
            <div class="modal-body">
                ...
                <form method="post" id="insert_form" action="modifierdoss.php">
                   ...
                   <input  name="nomp" id="nomp" class="form-control" value="<?php echo $data['Nom_patient']." ".$data['Prenom_patient'];?>"  
                   />
                <br><br>
                ...
                <br><br>
                   ...
                   <label><strong style="font-size: 20px">Spécialité médecin</strong></label><br>
                    ...
                    <button type="reset" onclick=window.location.href='dossier.php' class="btn btn-default" data-dismiss="modal" style="color:black;background-color:#DB1702"><strong>Annuler</strong> <img src="image\cancel.png" width="30"style="margin:5px" ></button>
                    <button type="submit" name="insert" id="insert" value="Enregistrer" class="btn btn-primary"style="color:black;background-color:#82E0AA"><strong>Modifier</strong> <img src="image\checkk.png" width="30"style="margin:5px" ></button>
