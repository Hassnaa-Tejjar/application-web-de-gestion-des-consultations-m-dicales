        ...
        <div class="modal-content">
          <div style=" border: 4px solid #76D7C4 ;width: 700px;margin-left: 300px;">
            <div  class="modal-header"style="background-color:#F1948A  ;width: 700px;font-size: 25px;height: 140px; ">
              ...
              <img src="image\dossier-medical.png" width="160" style="margin-bottom:-45px  " >
            </div>
