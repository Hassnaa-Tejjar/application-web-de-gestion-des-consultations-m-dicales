...
<div id="add_data_Modal" class="modal fade" tabindex="-1" role="dialog">
         ...
         <div style="border:4px solid #FCD21C;width:650px;margin-left:300px;">
             ...
             <div class="modal-body">
                 ...
                 <input name="id" id="id" class="form-control"style="width:150px;" value="<?php $requete=$connexionDB->query("SELECT count(patient.Nom_patient)   from ordonnance INNER JOIN consultation ON consultation.Id_consultation=ordonnance.Id_consultation INNER JOIN patient ON patient.Id_patient=consultation.Id_patient  WHERE patient.Nom_patient ="."'".$data['Nom_patient']."'"." AND dateordonnance <= "."'".$data['dateordonnance']."'"." ORDER BY dateordonnance")->fetch(); echo 'ordonnance N°: '.reset($requete); ?>" />
                    ...
                    <label style="position:relative;left:17px;"><strong>Date Ordonnance (*)</strong></label><br/>
                    <input type="date" name="date" id="date"  style="background-color:#BBAE98;position:relative;left:17px;" value="<?php echo $data['dateordonnance'];?>"/>
</th></table>
                    <hr/>
                  </div>
 ...
 <button onClick="imprimer('sectionAimprimer')" type="submit" name="insert" id="insert" value="Modifier" class="btn btn-primary"style="color:black;background-color:#689D71;margin-left: 840px"  ><strong>imprimer</strong> <img src="image\checkk.png" width="30"style="margin:5px" ></button>
