...
<head>
  ...
  <title>Consultation en ligne d'un cabiet medical </title>
  ...
  <link rel="stylesheet" type="text/css" href="dashboard/gritter/css/jquery.gritter.css" />
  <!-- Custom styles for this template -->
  <link href="css/style.css" rel="stylesheet">
  <link href="css/style-responsive.css" rel="stylesheet">
  <script src="dashboard/chart-master/Chart.js"></script>
...
<body>
  <section id="container">
    ...
    <header class="header black-bg">
      ...
      <!--logo start-->
      <a href="index.html" class="logo"><b>Consultaion<span>medicale</span></b></a>
      <!--logo end-->
          ...
          <li id="header_notification_bar" class="dropdown">
            ...
            <!-- <ul> <li>
                <a href="index.html#">
                  <span class="label label-danger"><i class="fa fa-bolt"></i></span>
                  home           .
                  <span class="small italic">       About Us.</span>
                  </a>
              </li>
              </ul>
...
<div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" align="left" >home</a></li>
        </ul>
      </div>
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="login.html">About Us</a></li>
        </ul>
      </div>
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout" href="login.html">Contact</a></li>
        </ul>
      </div>
    </header>
    <!--header end-->
    ...
    <aside>
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          <p class="centered"><img src="img/med.png" class="img-circle" width="100"></a></p>
          <h3 class="centered" style="color: white"> Consultation app </h3>
          <li class="mt">
            <a href="javascript:;">
              <img src="img/dash.png" width="22">
          ...
          <li class="sub-menu">
           ...
           <img src="img/house.png" width="22">
              <span>Acceuil</span>
              </a>
           <!-- <ul class="sub">
          ...
          <li class="active">
            <a  href="patientlist/listpat.php">
              <img src="img/patient.png" width="22">
               <span class="pat" >Patient    </span>
              </a>
           <!-- <ul class="sub">
             <a href="patientlist/listpat.php"></a> 
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              <img src="img/document.png" width="22">
    ...
    <strong style="text-align: center;">Copyright &copy; 2014-2021  Consultation medicale .</strong>
    All rights reserved.
