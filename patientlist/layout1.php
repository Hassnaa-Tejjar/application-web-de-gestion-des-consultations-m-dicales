...
<div class="top-menu">
        <ul class="nav pull-right top-menu">
          <li><a class="logout"  data-placement="right">home</a></li>
        </ul>
      </div>
      <div class="top-menu">
        <ul class="nav pull-right top-menu">
      ...
      <div id="sidebar" class="nav-collapse ">
        ...
        <ul class="sidebar-menu" id="nav-accordion">
          ...
          <li class="sub-menu">
           ...
           <img src="img/house.png" width="25">
              <span>Acceuil</span>
              </a>
           <!-- <ul class="sub">
          ...
          <li class="sub-menu">
            <a href="javascript:;">
              <img src="img/patient.png" width="25">
               <span class="pat" href="patientlist/listpat.php" >Patient    </span>
              </a>
           <!-- <ul class="sub">
